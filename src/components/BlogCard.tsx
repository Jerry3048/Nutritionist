...
const BlogCard: React.FC<Item> = ({title,category,authorName,authorImage,date,time,coverImage,description}) => {
  return (
    <div className="bg-green-100  overflow-hidden rounded-lg">
      ...
      <div className="p-4">
        ...
        {/* Title */}
        <h2 className="font-urbanistsemibold mt-1 text-[20px] sm:text-[22px] 2xl:text-[26px]">{title}</h2>

        <p className="text-[14px] sm:text-[16px] 2xl:text-[18px] mt-1 font-urbanistmedium">{description}</p>
            ...
            <div className="flex items-center mt-3 space-x-2">
              ...
              />
                <div className="flex flex-col justify-center">
                    <span className=" text-[14px] sm:text-[16px] 2xl:text-[18px] font-urbanistsemibold ">{authorName}</span>
