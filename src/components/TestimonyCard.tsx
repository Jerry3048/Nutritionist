...
const TestimonyCard : React.FC<Testimony> = ({id,name,image,testimony}) => {
  ...
  <div key={id}>
    <h1 className="text-[50px] text-[#356554]">"</h1>
     <p className="text-[14px] sm:text-[16px] 2xl:text-[18px] font-urbanistmedium">{testimony}</p>
     <div className="flex mt-5 space-x-2 items-center">
       <img
        ...
        />
        <h3 className=" items-center font-urbanistmedium text-[12px]  2xl:text-[18px]">{name}</h3>  
     </div>
