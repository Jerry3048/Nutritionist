...
export default function NutritionIcons() {
  const items: items[] = [
    {
      icon: <FaLeaf />,
      label: "Personalized Nutrition Plans",
      description:
    ...
    {
      icon: <FaUtensils />,
      label: "Food Tracking and Analysis",
      description:
    ...
    {
      icon: <MdSchool />,
      label: "Guidance from Certified Nutritionists",
      description:
    ...
    {
      icon: <FaCertificate />,
      label: "Nutritional Education and Workshops",
      description:
    ...
    {
      icon: <FaDumbbell />,
      label: "Lifestyle and Behavior Coaching",
      description:
  ...
  return (
    <div className="space-y-2 mt-30 w-[90%] mx-auto">
      <h1 className="flex justify-center items-center font-urbanistbold 2xl:text-[48px] sm:text-[38px] text-[28px] ">
        Features
      </h1>
      ...
      <div className="grid sm:grid-cols-2 grid-cols-1 gap-3">
        {items.map((item, idx) => (
          <div
            key={idx}
            className="flex flex-col text-gray-800 space-y-2 bg-[#F6FBE9] p-4 rounded-md"
          >
